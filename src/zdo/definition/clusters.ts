...
export enum ClusterId {
     ...
     *
     * If Dest. Address Mode = 0x03, then the Long Dest. Address will be
     ...
     *
     * This command SHALL NOT be APS encrypted regardless of
     ...
     *
     * This command SHALL NOT be APS encrypted. When performing
     ...
     *
     * This SHALL NOT be APS encrypted or NWK encrypted if the
