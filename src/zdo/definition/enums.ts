...
export const enum JoiningPolicy {
...
export const enum SelectedKeyNegotiationProtocol {
...
export const enum SelectedPreSharedSecret {
...
export const enum InitialJoinMethod {
    ANONYMOUS = 0x00,
...
export const enum ActiveLinkKeyType {
    NOT_UPDATED = 0x00,
