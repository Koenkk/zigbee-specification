import {Buffalo} from '../base/buffalo.js';
import {DEFAULT_ENCRYPTION_KEY_SIZE, EUI64_SIZE, EXTENDED_PAN_ID_SIZE, PAN_ID_SIZE} from '../base/definition/consts.js';
import {ClusterId, EUI64, NodeId, ProfileId} from '../base/definition/tstypes.js';
import {channelsToUInt32Mask} from '../base/utils.js';
import {ClusterId as ZdoClusterId} from './definition/clusters.js';
import {CHALLENGE_VALUE_SIZE, CURVE_PUBLIC_POINT_SIZE, MULTICAST_BINDING, UNICAST_BINDING, ZDO_MESSAGE_OVERHEAD} from './definition/consts.js';
import {GlobalTLV, LeaveRequestFlags, RoutingTableStatus} from './definition/enums.js';
...
import {
    ...
    TLV,
    ValidResponseMap,
} from './definition/tstypes.js';
import * as Utils from './utils.js';
import {ZdoStatusError} from './zdoStatusError.js';
...
export class BuffaloZdo extends Buffalo {
    ...
    private buildNwkUpdateRequest(
        ...
        this.writeUInt32(channelsToUInt32Mask(channels));
        this.writeUInt8(duration);
