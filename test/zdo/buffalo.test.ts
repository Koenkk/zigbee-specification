...
const SERVER_MASK_R22: ZdoTypes.ServerMask = {
...
const SERVER_MASK_R23: ZdoTypes.ServerMask = {
    primaryTrustCenter: 1,
    backupTrustCenter: 1,
    deprecated1: 0,
    deprecated2: 0,
...
describe('ZDO Buffalo', () => {
        ...
        expect(tlvs).toStrictEqual([
            {
                ...
                } as ZdoTypes.ManufacturerSpecificGlobalTLV,
            },
        ]);
    });
    ...
    it('Throws when writing invalid TLV tag', () => {
        ...
        expect(() => {
            buffalo.writeGlobalTLV({tagId: 0xfe, length: 2, tlv: {nwkPanIdConflictCount: NODE_ID2} as ZdoTypes.PanIdConflictReportGlobalTLV});
    ...
    it.each([
            ...
            [
                {
                    tagId: Zdo.GlobalTLV.MANUFACTURER_SPECIFIC,
                    length: 3,
                    tlv: {zigbeeManufacturerId: 256, additionalData: Buffer.from([123])} as ZdoTypes.ManufacturerSpecificGlobalTLV,
                },
            ],
        ],
        [
            ...
            [
                {
                    ...
                    } as ZdoTypes.SupportedKeyNegotiationMethodsGlobalTLV,
                },
            ],
        ],
        [
        ...
        [
            ...
            [
                {
                    tagId: Zdo.GlobalTLV.PAN_ID_CONFLICT_REPORT,
                    length: 2,
                    tlv: {nwkPanIdConflictCount: NODE_ID2} as ZdoTypes.PanIdConflictReportGlobalTLV,
                },
            ],
        ],
        [
            ...
            [{tagId: Zdo.GlobalTLV.NEXT_PAN_ID_CHANGE, length: 2, tlv: {panId: 0xff00} as ZdoTypes.NextPanIdChangeGlobalTLV}],
        ],
        [
            'NEXT_CHANNEL_CHANGE',
            [Zdo.GlobalTLV.NEXT_CHANNEL_CHANGE, 4 - 1, ...uint32To8Array(423432)],
            [{tagId: Zdo.GlobalTLV.NEXT_CHANNEL_CHANGE, length: 4, tlv: {channel: 423432} as ZdoTypes.NextChannelChangeGlobalTLV}],
        ],
        [
            ...
            [
                {
                    ...
                    tlv: {passphrase: Buffer.alloc(ZSpec.DEFAULT_ENCRYPTION_KEY_SIZE).fill(0xca)} as ZdoTypes.SymmetricPassphraseGlobalTLV,
                },
            ],
        ],
        [
            ...
            [{tagId: Zdo.GlobalTLV.ROUTER_INFORMATION, length: 2, tlv: {bitmask: 4396} as ZdoTypes.RouterInformationGlobalTLV}],
        ],
        [
            ...
            [
                {
                    ...
                    length: 5,
                    tlv: {nwkAddress: NODE_ID1, fragmentationOptions: 5, maxIncomingTransferUnit: 32456} as ZdoTypes.FragmentationParametersGlobalTLV,
                },
            ],
        ],
        [
            ...
            [
                {
                    ...
                    } as ZdoTypes.JoinerEncapsulationGlobalTLV,
                },
            ],
        ],
        [
            ...
            [
                {
                    ...
                    } as ZdoTypes.BeaconAppendixEncapsulationGlobalTLV,
                },
            ],
        ],
        [
            ...
            [
                {
                    tagId: Zdo.GlobalTLV.CONFIGURATION_PARAMETERS,
                    length: 2,
                    tlv: {configurationParameters: 47593} as ZdoTypes.ConfigurationParametersGlobalTLV,
                },
            ],
        ],
        [
            ...
            [
                {
                    ...
                    length: 3,
                    tlv: {data: Buffer.from([3, 1, 2])} as ZdoTypes.DeviceCapabilityExtensionGlobalTLV,
                },
            ],
        ],
        ['invalid', [0xfe, 0, 0], []],
    ...
    it('Throws when building unknown cluster ID', () => {
        ...
        expect(() => {
            ...
            Zdo.Buffalo.buildRequest(true, clusterId, Buffer.from([1, 123]));
    ...
    it('buildNodeDescriptorRequest', () => {
        ...
        const tlv: ZdoTypes.FragmentationParametersGlobalTLV = {
            nwkAddress: NODE_ID1,
        ...
        const tlv2: ZdoTypes.FragmentationParametersGlobalTLV = {
            nwkAddress: NODE_ID1,
        ...
        const tlv3: ZdoTypes.FragmentationParametersGlobalTLV = {
            nwkAddress: NODE_ID1,
            /*fragmentationOptions: undefined,*/
        ...
        const tlv4: ZdoTypes.FragmentationParametersGlobalTLV = {
            nwkAddress: NODE_ID1,
            fragmentationOptions: 1,
    ...
    it('buildClearAllBindingsRequest', () => {
        ...
        expect(
            Zdo.Buffalo.buildRequest(true, Zdo.ClusterId.CLEAR_ALL_BINDINGS_REQUEST, {eui64List} as ZdoTypes.ClearAllBindingsReqEUI64TLV),
        ).toStrictEqual(
    ...
    it('buildNwkBeaconSurveyRequest', () => {
        const tlv: ZdoTypes.BeaconSurveyConfigurationTLV = {
            scanChannelList: [],
        ...
        const tlv2: ZdoTypes.BeaconSurveyConfigurationTLV = {
        ...
        const tlv3: ZdoTypes.BeaconSurveyConfigurationTLV = {
    ...
    it('buildStartKeyNegotiationRequest', () => {
        const tlv: ZdoTypes.Curve25519PublicPointTLV = {
            eui64: IEEE_ADDRESS1,
        ...
        const tlv2: ZdoTypes.Curve25519PublicPointTLV = {
            eui64: IEEE_ADDRESS2,
    ...
    it('buildRetrieveAuthenticationTokenRequest', () => {
        const tlv: ZdoTypes.AuthenticationTokenIdTLV = {tlvTypeTagId: 0};
        ...
        const tlv2: ZdoTypes.AuthenticationTokenIdTLV = {tlvTypeTagId: 31};
    ...
    it('buildGetAuthenticationLevelRequest', () => {
        const tlv: ZdoTypes.TargetIEEEAddressTLV = {ieee: IEEE_ADDRESS2};
    ...
    it.each([
        ...
        expect(
            Zdo.Buffalo.buildRequest(
                ...
                {panId} as ZdoTypes.NextPanIdChangeGlobalTLV,
                {channel} as ZdoTypes.NextChannelChangeGlobalTLV,
                {configurationParameters} as ZdoTypes.ConfigurationParametersGlobalTLV,
            ),
        ).toStrictEqual(
            Buffer.from([
                0,
    ...
    it('buildStartKeyUpdateRequest', () => {
        const method: ZdoTypes.SelectedKeyNegotiationMethodTLV = {
        ...
        const params: ZdoTypes.FragmentationParametersGlobalTLV = {
            nwkAddress: NODE_ID1,
            fragmentationOptions: 1,
    ...
    it('buildDecommissionRequest', () => {
        const tlv: ZdoTypes.DeviceEUI64ListTLV = {
        ...
        const tlv2: ZdoTypes.DeviceEUI64ListTLV = {
        ...
        const tlv3: ZdoTypes.DeviceEUI64ListTLV = {
            eui64List: [],
        };
    ...
    it('buildChallengeRequest', () => {
        const tlv: ZdoTypes.APSFrameCounterChallengeTLV = {
        ...
        const tlv2: ZdoTypes.APSFrameCounterChallengeTLV = {
    ...
    it('Throws when reading unknown cluster ID', () => {
        ...
        expect(() => {
            Zdo.Buffalo.readResponse(true, clusterId, Buffer.from([1, 123]));
    ...
    it('readIEEEAddressResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.IEEE_ADDRESS_RESPONSE, buffer)).toStrictEqual([
            Zdo.Status.SUCCESS,
            {
                ...
                startIndex: 0,
                assocDevList: [],
            } as ZdoTypes.IEEEAddressResponse,
        ]);
        const bufferWAssoc = Buffer.from([
            1,
            Zdo.Status.SUCCESS,
    ...
    it('readSystemServerDiscoveryResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.SYSTEM_SERVER_DISCOVERY_RESPONSE, buffer)).toStrictEqual([
            ...
            {
                serverMask: SERVER_MASK_R23,
            } as ZdoTypes.SystemServerDiscoveryResponse,
        ]);
    });
    ...
    it('readRoutingTableResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.ROUTING_TABLE_RESPONSE, buffer)).toStrictEqual([
            ...
            } as ZdoTypes.RoutingTableResponse,
        ]);
    ...
    it('readBindingTableResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.BINDING_TABLE_RESPONSE, buffer)).toStrictEqual([
            ...
            } as ZdoTypes.BindingTableResponse,
        ]);
    ...
    it('readNwkEnhancedUpdateResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.NWK_ENHANCED_UPDATE_RESPONSE, buffer)).toStrictEqual([
            Zdo.Status.SUCCESS,
            {
                ...
                totalFailures: 34,
                entryList: [0x43, 0xff, 0x6f],
            } as ZdoTypes.NwkEnhancedUpdateResponse,
        ]);
    });
    ...
    it('readNwkIEEEJoiningListResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.NWK_IEEE_JOINING_LIST_RESPONSE, buffer)).toStrictEqual([
            ...
            } as ZdoTypes.NwkIEEEJoiningListResponse,
        ]);
    ...
    it('readNwkUnsolicitedEnhancedUpdateResponse', () => {
        ...
        expect(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.NWK_UNSOLICITED_ENHANCED_UPDATE_RESPONSE, buffer)).toStrictEqual([
            Zdo.Status.SUCCESS,
            {
                ...
                timePeriod: 32,
            } as ZdoTypes.NwkUnsolicitedEnhancedUpdateResponse,
        ]);
    });
                ...
                tlvs: [
                    {
                        ...
                        } as ZdoTypes.BeaconSurveyResultsTLV,
                    },
                    {
                        tagId: 0x02,
                        length: 7,
                        ...
                        } as ZdoTypes.PotentialParentsTLV,
                    },
                ],
            } as ZdoTypes.NwkBeaconSurveyResponse,
        ]);
                ...
                tlvs: [
                    {
                        ...
                        } as ZdoTypes.Curve25519PublicPointTLV,
                    },
                ],
            },
        ]);
                ...
                tlvs: [
                    {
                        ...
                        } as ZdoTypes.DeviceAuthenticationLevelTLV,
                    },
                ],
            },
        ]);
                ...
                tlvs: [
                    {
                        ...
                        } as ZdoTypes.ProcessingStatusTLV,
                    },
                ],
            },
        ]);
                ...
                tlvs: [
                    {
                        ...
                        } as ZdoTypes.APSFrameCounterResponseTLV,
                    },
                ],
            },
        ]);
    ...
    it('checks status of response, with and without overhead', () => {
        const buffer = Buffer.from([1, Zdo.Status.SUCCESS, ...IEEE_ADDRESS1_BYTES, ...NODE_ID1_BYTES]);
        const bufferNoOverhead = Buffer.from([Zdo.Status.SUCCESS, ...IEEE_ADDRESS1_BYTES, ...NODE_ID1_BYTES]);

        expect(Zdo.Buffalo.checkStatus(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.NETWORK_ADDRESS_RESPONSE, buffer))).toStrictEqual(true);
        expect(Zdo.Buffalo.checkStatus(Zdo.Buffalo.readResponse(false, Zdo.ClusterId.NETWORK_ADDRESS_RESPONSE, bufferNoOverhead))).toStrictEqual(
            true,
        );

        const bufferFail = Buffer.from([1, Zdo.Status.INV_REQUESTTYPE]);
        const bufferFailNoOverhead = Buffer.from([Zdo.Status.INV_REQUESTTYPE]);

        expect(Zdo.Buffalo.checkStatus(Zdo.Buffalo.readResponse(true, Zdo.ClusterId.NETWORK_ADDRESS_RESPONSE, bufferFail))).toStrictEqual(false);
        expect(Zdo.Buffalo.checkStatus(Zdo.Buffalo.readResponse(false, Zdo.ClusterId.NETWORK_ADDRESS_RESPONSE, bufferFailNoOverhead))).toStrictEqual(
            false,
        );
    });
});
